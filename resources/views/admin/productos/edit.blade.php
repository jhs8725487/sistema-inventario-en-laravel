...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title"><b>Modifique los datos del producto</b></h3>
    </div>

    {{-- El método debe ser POST con @method('PUT') para update --}}
    <form action="{{ url('/admin/productos/'.$producto->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
                    ...
                    <div class="mt-2">
                        @if($producto->imagen)
                            <img src="{{ asset('storage/'.$producto->imagen) }}" 
                                 id="preview"
                                 style="max-width:100%; height:120px; border:1px solid #ddd; padding:3px;">
                        @else
                            <img id="preview" src="#" style="max-width:100%; height:120px; display:none; border:1px solid #ddd; padding:3px;">
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="descripcion" id="descripcion" class="form-control" rows="4" required>{{ old('descripcion', $producto->descripcion) }}</textarea>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="stock_maximo" id="stock_maximo" class="form-control"
                               value="{{ old('stock_maximo', $producto->stock_maximo) }}" required>
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <select name="unidad_medida" id="unidad_medida" class="form-control" required>
                        <option value="">-- Seleccione --</option>
                        @foreach(['Unidad','Litro','Kg','Caja'] as $u)
